    ...
    public partial class MigrationV1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), 0, "eeaebbac-72fc-4d33-8390-dbde990b3ffe", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 211, DateTimeKind.Utc).AddTicks(2077), "admin@iyyel.io", true, "Admin", "", false, null, "", new Guid("00000000-0000-0000-0000-000000000000"), null, "ADMIN@IYYEL.IO", "ADMIN@IYYEL.IO", "AQAAAAIAAYagAAAAEMuR9/VQYedeRPW+QgE+CC/BIa5CHSKUhCkWmoD/8spOCoI5MB/j8VcL1d4vqQ44tg==", "21212121", true, new Guid("00000000-0000-0000-0000-000000000000"), null, "admin", false, "admin@iyyel.io" },
                    { new Guid("de05b775-a344-497f-a091-643d267ff25d"), 0, "e582f153-e634-4973-93a8-e30c95e07de8", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 252, DateTimeKind.Utc).AddTicks(234), "james@butler.xyz", true, "James", "Butler", false, null, "", new Guid("00000000-0000-0000-0000-000000000000"), null, "JAMES@BUTLER.XYZ", "JAMES@BUTLER.XYZ", "AQAAAAIAAYagAAAAELV8NY5quulkT3+a7sz0xVuCMd28qtWLFlY0qGaBeg0B/+V2GE3i/OCpmqMI+OwVGg==", "23232323", true, new Guid("00000000-0000-0000-0000-000000000000"), null, "james", false, "james@butler.xyz" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("295efc76-56d6-4839-ada4-25924f912aa0"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 251, DateTimeKind.Utc).AddTicks(9987), "Admin Seed Bloq Description 1/2", false, true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 8, 9, 18, 32, 32, 251, DateTimeKind.Utc).AddTicks(9985), new Guid("00000000-0000-0000-0000-000000000000"), null, "Admin Seed Bloq Title 1/2" },
                    { new Guid("dc5b12fd-f5a3-4a04-a6e0-c4cd552cd6b5"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4148), "James Seed Bloq Description", false, true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4146), new Guid("00000000-0000-0000-0000-000000000000"), null, "James Seed Bloq Title" },
                    { new Guid("f8d31b28-1c9a-43c0-aebd-19236af4422f"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 251, DateTimeKind.Utc).AddTicks(9992), "Admin Seed Bloq Description 2/2", true, false, new Guid("00000000-0000-0000-0000-000000000000"), null, null, new Guid("00000000-0000-0000-0000-000000000000"), null, "Admin Seed Bloq Title 2/2" }
                });

            migrationBuilder.InsertData(
                table: "Bloqqer.Follows",
                columns: new[] { "Id", "CreatedBy", "CreatedOn", "FollowedId", "FollowerId", "ModifiedBy", "ModifiedOn", "RemovedBy", "RemovedOn" },
                values: new object[] { new Guid("aac1463f-f051-4407-8ee6-f23431e9ccaa"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4180), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("00000000-0000-0000-0000-000000000000"), null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), new Guid("dc5b12fd-f5a3-4a04-a6e0-c4cd552cd6b5"), "James Seed Bloq Post 1/2 Content", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4157), "James Seed Bloq Post 1/2 Description", true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4156), new Guid("00000000-0000-0000-0000-000000000000"), null, "James Seed Bloq Post 1/2" },
                    { new Guid("0cb3379f-6bea-424d-ba0f-a44f4fa6a11a"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("295efc76-56d6-4839-ada4-25924f912aa0"), "Admin Seed Bloq Post 1/2 Content", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 251, DateTimeKind.Utc).AddTicks(9999), "Admin Seed Bloq Post 1/2 Description", true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 8, 9, 18, 32, 32, 251, DateTimeKind.Utc).AddTicks(9999), new Guid("00000000-0000-0000-0000-000000000000"), null, "Admin Seed Bloq Post 1/2" },
                    { new Guid("efab75ca-f1ac-4211-8076-e344b9c98025"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("295efc76-56d6-4839-ada4-25924f912aa0"), "Admin Seed Bloq Post 2/2 Content", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 252, DateTimeKind.Utc).AddTicks(2), "Admin Seed Bloq Post 2/2 Description", false, new Guid("00000000-0000-0000-0000-000000000000"), null, null, new Guid("00000000-0000-0000-0000-000000000000"), null, "Admin Seed Bloq Post 2/2" },
                    { new Guid("f298d1f6-9ae6-477c-af37-173f959cdd1c"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), new Guid("dc5b12fd-f5a3-4a04-a6e0-c4cd552cd6b5"), "James Seed Bloq Post 2/2 Content", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4167), "James Seed Bloq Post 2/2 Description", true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4167), new Guid("00000000-0000-0000-0000-000000000000"), null, "James Seed Bloq Post 2/2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("180daba0-d465-40d0-bb01-68e0ac40b86c"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), "Admin Seed Bloq Post 1 Comment 2/2", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 252, DateTimeKind.Utc).AddTicks(60), false, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0cb3379f-6bea-424d-ba0f-a44f4fa6a11a"), null, new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("1af0038f-73a2-4fbb-867f-75a90cf33536"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), "Admin Seed Bloq Post 1 Comment 1/2", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 252, DateTimeKind.Utc).AddTicks(58), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0cb3379f-6bea-424d-ba0f-a44f4fa6a11a"), new DateTime(2024, 8, 9, 18, 32, 32, 252, DateTimeKind.Utc).AddTicks(57), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("3e8f006d-04c7-4d2b-97a2-108de9b39b3a"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), "Admin Seed Bloq Post 2 Comment 1/2", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 252, DateTimeKind.Utc).AddTicks(61), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("efab75ca-f1ac-4211-8076-e344b9c98025"), new DateTime(2024, 8, 9, 18, 32, 32, 252, DateTimeKind.Utc).AddTicks(61), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("49304138-ec9e-495e-8774-d4b2b64781ce"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), "James Seed Bloq Post 1 Comment 2/3", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4176), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4175), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("679dee46-f2f2-4859-bedc-7d542eae5089"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), "James Seed Bloq Post 1 Comment 3/3", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4177), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4177), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("d1cd67d2-67e5-4c6f-aabb-cb4056dd5064"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), "James Seed Bloq Post 1 Comment 1/3", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4172), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4172), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("fcc41c42-f406-4b28-9b4f-c7e02ccb6380"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), "Admin Seed Bloq Post 2 Comment 2/2", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 252, DateTimeKind.Utc).AddTicks(63), false, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("efab75ca-f1ac-4211-8076-e344b9c98025"), null, new Guid("00000000-0000-0000-0000-000000000000"), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0fe8f779-88d5-46dc-a705-48eabe7691de"), null, null, new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4166), new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("7a8504bd-5204-4ff7-8473-9b8a625d5d52"), null, null, new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4164), new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("981f0e58-66df-4329-add8-3eaba8ae51d3"), null, new Guid("d1cd67d2-67e5-4c6f-aabb-cb4056dd5064"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 8, 9, 18, 32, 32, 290, DateTimeKind.Utc).AddTicks(4174), new Guid("00000000-0000-0000-0000-000000000000"), null, null, new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("00000000-0000-0000-0000-000000000000"), null }
                });
