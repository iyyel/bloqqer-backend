    ...
    public partial class MigrationV1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), 0, "85158da7-ad05-4843-b62b-e59635992409", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 174, DateTimeKind.Utc).AddTicks(6675), "admin@iyyel.io", true, "Admin", "", false, null, "", new Guid("00000000-0000-0000-0000-000000000000"), null, "ADMIN@IYYEL.IO", "ADMIN@IYYEL.IO", "AQAAAAIAAYagAAAAEJGDJlVSTxWpviQrL8ssPK/ws87ukCjoA8D+bE/4OIAodTPHUp160bqFhl/v55FtCA==", "21212121", true, new Guid("00000000-0000-0000-0000-000000000000"), null, "admin", false, "admin@iyyel.io" },
                    { new Guid("de05b775-a344-497f-a091-643d267ff25d"), 0, "fcfb4a35-647f-497c-98cb-abe7c0e4b3a6", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8627), "james@butler.xyz", true, "James", "Butler", false, null, "", new Guid("00000000-0000-0000-0000-000000000000"), null, "JAMES@BUTLER.XYZ", "JAMES@BUTLER.XYZ", "AQAAAAIAAYagAAAAEN4bZgbMQCSE/9XDeXueiGGVyap5DTNLlZIKOH0D3auvAWr8dBLtUb7FavLGjjZgeQ==", "23232323", true, new Guid("00000000-0000-0000-0000-000000000000"), null, "james", false, "james@butler.xyz" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("295efc76-56d6-4839-ada4-25924f912aa0"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8303), "Admin Seed Bloq Description 1/2", false, true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8300), new Guid("00000000-0000-0000-0000-000000000000"), null, "Admin Seed Bloq Title 1/2" },
                    { new Guid("dc5b12fd-f5a3-4a04-a6e0-c4cd552cd6b5"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3023), "James Seed Bloq Description", false, true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3020), new Guid("00000000-0000-0000-0000-000000000000"), null, "James Seed Bloq Title" },
                    { new Guid("f8d31b28-1c9a-43c0-aebd-19236af4422f"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8309), "Admin Seed Bloq Description 2/2", true, false, new Guid("00000000-0000-0000-0000-000000000000"), null, null, new Guid("00000000-0000-0000-0000-000000000000"), null, "Admin Seed Bloq Title 2/2" }
                });

            migrationBuilder.InsertData(
                table: "Bloqqer.Follows",
                columns: new[] { "Id", "CreatedBy", "CreatedOn", "FollowedId", "FollowerId", "ModifiedBy", "ModifiedOn", "RemovedBy", "RemovedOn" },
                values: new object[] { new Guid("aac1463f-f051-4407-8ee6-f23431e9ccaa"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3061), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("00000000-0000-0000-0000-000000000000"), null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), new Guid("dc5b12fd-f5a3-4a04-a6e0-c4cd552cd6b5"), "James Seed Bloq Post 1/2 Content", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3034), "James Seed Bloq Post 1/2 Description", true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3034), new Guid("00000000-0000-0000-0000-000000000000"), null, "James Seed Bloq Post 1/2" },
                    { new Guid("0cb3379f-6bea-424d-ba0f-a44f4fa6a11a"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("295efc76-56d6-4839-ada4-25924f912aa0"), "Admin Seed Bloq Post 1/2 Content", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8318), "Admin Seed Bloq Post 1/2 Description", true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8317), new Guid("00000000-0000-0000-0000-000000000000"), null, "Admin Seed Bloq Post 1/2" },
                    { new Guid("efab75ca-f1ac-4211-8076-e344b9c98025"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("295efc76-56d6-4839-ada4-25924f912aa0"), "Admin Seed Bloq Post 2/2 Content", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8321), "Admin Seed Bloq Post 2/2 Description", false, new Guid("00000000-0000-0000-0000-000000000000"), null, null, new Guid("00000000-0000-0000-0000-000000000000"), null, "Admin Seed Bloq Post 2/2" },
                    { new Guid("f298d1f6-9ae6-477c-af37-173f959cdd1c"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), new Guid("dc5b12fd-f5a3-4a04-a6e0-c4cd552cd6b5"), "James Seed Bloq Post 2/2 Content", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3047), "James Seed Bloq Post 2/2 Description", true, new Guid("00000000-0000-0000-0000-000000000000"), null, new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3047), new Guid("00000000-0000-0000-0000-000000000000"), null, "James Seed Bloq Post 2/2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("180daba0-d465-40d0-bb01-68e0ac40b86c"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), "Admin Seed Bloq Post 1 Comment 2/2", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8329), false, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0cb3379f-6bea-424d-ba0f-a44f4fa6a11a"), null, new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("1af0038f-73a2-4fbb-867f-75a90cf33536"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), "Admin Seed Bloq Post 1 Comment 1/2", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8327), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0cb3379f-6bea-424d-ba0f-a44f4fa6a11a"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8326), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("3e8f006d-04c7-4d2b-97a2-108de9b39b3a"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), "Admin Seed Bloq Post 2 Comment 1/2", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8372), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("efab75ca-f1ac-4211-8076-e344b9c98025"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8372), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("49304138-ec9e-495e-8774-d4b2b64781ce"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), "James Seed Bloq Post 1 Comment 2/3", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3056), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3055), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("679dee46-f2f2-4859-bedc-7d542eae5089"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), "James Seed Bloq Post 1 Comment 3/3", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3057), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3057), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("d1cd67d2-67e5-4c6f-aabb-cb4056dd5064"), new Guid("de05b775-a344-497f-a091-643d267ff25d"), "James Seed Bloq Post 1 Comment 1/3", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3052), true, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3052), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("fcc41c42-f406-4b28-9b4f-c7e02ccb6380"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), "Admin Seed Bloq Post 2 Comment 2/2", new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 214, DateTimeKind.Utc).AddTicks(8374), false, new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("efab75ca-f1ac-4211-8076-e344b9c98025"), null, new Guid("00000000-0000-0000-0000-000000000000"), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0fe8f779-88d5-46dc-a705-48eabe7691de"), null, null, new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3044), new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("7a8504bd-5204-4ff7-8473-9b8a625d5d52"), null, null, new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3042), new Guid("00000000-0000-0000-0000-000000000000"), null, new Guid("0afda5fc-0a56-45b6-a983-3018048c204a"), new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("00000000-0000-0000-0000-000000000000"), null },
                    { new Guid("981f0e58-66df-4329-add8-3eaba8ae51d3"), null, new Guid("d1cd67d2-67e5-4c6f-aabb-cb4056dd5064"), new Guid("2afb7b32-9305-4c43-90d3-78412603e4ff"), new DateTime(2024, 7, 31, 9, 24, 13, 254, DateTimeKind.Utc).AddTicks(3054), new Guid("00000000-0000-0000-0000-000000000000"), null, null, new Guid("c108f0d4-7f9f-49eb-8a18-9f9bd81e1765"), new Guid("00000000-0000-0000-0000-000000000000"), null }
                });
